...
import {cantidadCaracteres, validarAltura, validarDNI, validarEdad, validarGenero, validarPeso, validarFechaNacimiento} from './helpers.js';
...
function crearPersona(e) {
  ...
  if(cantidadCaracteres(nombre) &&  validarEdad(edad) && validarDNI(dni) && validarAltura(altura) && validarGenero(genero)){
...
let reseteoDatosForm = document.querySelector("#resetForm");
